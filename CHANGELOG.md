...
## Fork Changes (FoundD-oka/claude-code-action@beta)
...
- **Updated Base Action**: Uses `FoundD-oka/claude-code-base-action@beta` which includes OAuth credential handling
